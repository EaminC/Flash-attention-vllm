...
# 模拟 Flash Attention 计算（替换为实际的 Flash Attention 调用）
...
if __name__ == "__main__":
    benchmark_flash_attention(batch_size=2, seq_len=2048, nheads=8, headdim=64, spread_min=1, spread_max=100, spread_step=1)